...
ServerWorkerZmq::ServerWorkerZmq(zmq::context_t &ctx, int sock_type)
    : ctx_{ctx},
...
ServerWorkerZmq::~ServerWorkerZmq()
{
}

void ServerWorkerZmq::setMessageProcessor(MessageProcessorSharedPtr  inProcessor)
{
    this->processor_ = inProcessor;
}

void ServerWorkerZmq::run()
{
...
void ServerWorkerZmq::internalRun()
{
...
ServerMessage ServerWorkerZmq::forward(const string& inServerName, const ServerMessage& inMessage)
{
