...
enum class OperationCodeEnum {
    ...
    CODE_FDS_GET_PASSES = 401,
    CODE_FDS_GET_PASSES_RESPONSE = 402,
    CODE_FDS_MESSAGE = 403,
    
    CODE_FDS_ORB_PROPAGATION = 404,
    CODE_FDS_ORB_DETERMINATION = 405,
