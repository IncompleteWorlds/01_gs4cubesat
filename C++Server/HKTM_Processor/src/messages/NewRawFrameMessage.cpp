...
ServerMessage NewRawFrameMessage::processMessage(const ServerMessage &inMessage, ServerWorkerZmq &inParent)
{
...
void NewRawFrameMessage::publishEvent(const ServerMessage &inMessage, ServerWorkerZmq &inParent)
{
}
