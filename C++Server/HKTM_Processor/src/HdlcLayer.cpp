...
IW::ProcessedFrame HdlcLayer::indication(RawFrameType &inRawData)
{
...
IW::ProcessedFrame HdlcLayer::confirm(RawFrameType &inRawData)
{
    IW::ProcessedFrame  outputFrame;
...
int HdlcLayer::decodeFrame(RawFrameType &inData, IW::ProcessedFrame &outData)
{
    int output = -1;
