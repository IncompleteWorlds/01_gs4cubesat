...
IW::ProcessedFrame ApplicationLayer::indication(RawFrameType &inRawData)
{
    IW::ProcessedFrame output;
...
IW::ProcessedFrame ApplicationLayer::confirm(RawFrameType &inRawData)
{
    IW::ProcessedFrame output;
