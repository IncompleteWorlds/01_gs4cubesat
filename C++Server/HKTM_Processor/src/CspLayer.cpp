...
IW::ProcessedFrame CspLayer::indication(RawFrameType &inRawData)
{
...
IW::ProcessedFrame CspLayer::confirm(RawFrameType &inRawData)
{
    IW::ProcessedFrame  outputFrame;
...
int CspLayer::decodeFrame(RawFrameType& inData, IW::ProcessedFrame &outFrame)
{
    int output = -1;
    ...
    else
    {
        ...
        // Add group
        outFrame.groups.push_back(cspGroup);
