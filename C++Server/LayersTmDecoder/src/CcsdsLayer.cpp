...
const string CcsdsLayer::LAYER_NAME = "CCSDS";

CcsdsLayer::CcsdsLayer()
{
    dataFieldIndex_ = 0;
    dataGroupIndex_ = 0;
}
...
RawFrameType CcsdsLayer::request(RawFrameType &inRawData)
{
...
IW::TM_ProcessedFrame CcsdsLayer::indication(RawFrameType &inRawData)
{
...
RawFrameType CcsdsLayer::response(RawFrameType &inRawData)
{
    RawFrameType  outputFrame;
...
IW::TM_ProcessedFrame CcsdsLayer::confirm(RawFrameType &inRawData)
{
    IW::TM_ProcessedFrame  outputFrame;
...
void CcsdsLayer::encodeFrame(RawFrameType& inData, RawFrameType &outData)
{
    if (inData.size() > 0)
    {
...
int CcsdsLayer::decodeFrame(RawFrameType& inData, IW::TM_ProcessedFrame &outFrame)
{
    int output = -1;
...
int CcsdsLayer::processHeader(Bitstream &inBitStream, uint &outCounter, IW::GroupProcessedField &outData)
{
    int output = -1;
...
int CcsdsLayer::processInfo(Bitstream &inBitStream, uint &outCounter, uint inFrameLength, IW::GroupProcessedField &outData)
{
    int output = -1;
