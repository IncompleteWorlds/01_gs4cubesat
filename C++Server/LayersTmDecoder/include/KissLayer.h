...
#ifndef __KISSLAYER_H__
#define __KISSLAYER_H__
...
class KissLayer : public BaseLayer
{
public:
    ...
    IW::TM_ProcessedFrame indication(RawFrameType& inRawData);
    ...
    //    been completed.
    IW::TM_ProcessedFrame confirm(RawFrameType& inRawData);
...
protected:
    ...
    int decodeFrame(RawFrameType& inData, IW::TM_ProcessedFrame &outData);
};

#endif // __KISSLAYER_H__
