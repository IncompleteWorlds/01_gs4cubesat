...
/** This message retrieves a TM Parameter. If the TM Parameter Id is null, it will use the Node and Channel parameters. If the Channel Id is null, it will return all TM Parameters of the Node. It returns a List of TM Parameter object */
@org.apache.avro.specific.AvroGenerated
public class MsgGetTmParameter extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7397089410933389477L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MsgGetTmParameter\",\"namespace\":\"com.incomplete.cubegs.common.avro.messages\",\"doc\":\"This message retrieves a TM Parameter. If the TM Parameter Id is null, it will use the Node and Channel parameters. If the Channel Id is null, it will return all TM Parameters of the Node. It returns a List of TM Parameter object\",\"fields\":[{\"name\":\"authorizationToken\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Authorization token\"},{\"name\":\"tmParameterId\",\"type\":\"int\",\"doc\":\"TM Parameter identifier\"},{\"name\":\"nodeId\",\"type\":\"int\",\"doc\":\"Node or subsystem identifier\"},{\"name\":\"channelId\",\"type\":\"int\",\"doc\":\"Channel identifier or tm point identifier within subsystem\"}]}");
   ...
   */
  public MsgGetTmParameter(java.lang.String authorizationToken, java.lang.Integer tmParameterId, java.lang.Integer nodeId, java.lang.Integer channelId) {
  ...
  /**
   * Creates a new MsgGetTmParameter RecordBuilder.
   * @return A new MsgGetTmParameter RecordBuilder
   */
  public static com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder newBuilder() {
    return new com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder();
  }

  /**
   * Creates a new MsgGetTmParameter RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new MsgGetTmParameter RecordBuilder
   */
  public static com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder newBuilder(com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder other) {
    return new com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder(other);
  }

  /**
   * Creates a new MsgGetTmParameter RecordBuilder by copying an existing MsgGetTmParameter instance.
   * @param other The existing instance to copy.
   * @return A new MsgGetTmParameter RecordBuilder
   */
  public static com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder newBuilder(com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter other) {
    return new com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder(other);
  }

  /**
   * RecordBuilder for MsgGetTmParameter instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MsgGetTmParameter>
    implements org.apache.avro.data.RecordBuilder<MsgGetTmParameter> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing MsgGetTmParameter instance
     * @param other The existing instance to copy.
     */
    private Builder(com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.authorizationToken)) {
        this.authorizationToken = data().deepCopy(fields()[0].schema(), other.authorizationToken);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder setAuthorizationToken(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder clearAuthorizationToken() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder setTmParameterId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder clearTmParameterId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder setNodeId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder clearNodeId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder setChannelId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgGetTmParameter.Builder clearChannelId() {
      fieldSetFlags()[3] = false;
      return this;
    }

    @Override
    public MsgGetTmParameter build() {
      try {
        MsgGetTmParameter record = new MsgGetTmParameter();
