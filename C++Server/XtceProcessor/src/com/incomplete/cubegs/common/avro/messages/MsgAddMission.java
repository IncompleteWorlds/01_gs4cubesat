...
public class MsgAddMission extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public MsgAddMission(java.lang.String authorizationToken, com.incomplete.cubegs.common.avro.messages.Mission mission) {
  ...
  /**
   * Creates a new MsgAddMission RecordBuilder.
   * @return A new MsgAddMission RecordBuilder
   */
  public static com.incomplete.cubegs.common.avro.messages.MsgAddMission.Builder newBuilder() {
    return new com.incomplete.cubegs.common.avro.messages.MsgAddMission.Builder();
  }

  /**
   * Creates a new MsgAddMission RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new MsgAddMission RecordBuilder
   */
  public static com.incomplete.cubegs.common.avro.messages.MsgAddMission.Builder newBuilder(com.incomplete.cubegs.common.avro.messages.MsgAddMission.Builder other) {
    return new com.incomplete.cubegs.common.avro.messages.MsgAddMission.Builder(other);
  }

  /**
   * Creates a new MsgAddMission RecordBuilder by copying an existing MsgAddMission instance.
   * @param other The existing instance to copy.
   * @return A new MsgAddMission RecordBuilder
   */
  public static com.incomplete.cubegs.common.avro.messages.MsgAddMission.Builder newBuilder(com.incomplete.cubegs.common.avro.messages.MsgAddMission other) {
    return new com.incomplete.cubegs.common.avro.messages.MsgAddMission.Builder(other);
  }

  /**
   * RecordBuilder for MsgAddMission instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MsgAddMission>
    implements org.apache.avro.data.RecordBuilder<MsgAddMission> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.incomplete.cubegs.common.avro.messages.MsgAddMission.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing MsgAddMission instance
     * @param other The existing instance to copy.
     */
    private Builder(com.incomplete.cubegs.common.avro.messages.MsgAddMission other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.authorizationToken)) {
        this.authorizationToken = data().deepCopy(fields()[0].schema(), other.authorizationToken);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgAddMission.Builder setAuthorizationToken(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgAddMission.Builder clearAuthorizationToken() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgAddMission.Builder setMission(com.incomplete.cubegs.common.avro.messages.Mission value) {
     ...
     * @return This builder.
     */
    public com.incomplete.cubegs.common.avro.messages.MsgAddMission.Builder setMissionBuilder(com.incomplete.cubegs.common.avro.messages.Mission.Builder value) {
      clearMission();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgAddMission.Builder clearMission() {
      mission = null;
      missionBuilder = null;
    ...
    @Override
    public MsgAddMission build() {
      try {
        MsgAddMission record = new MsgAddMission();
