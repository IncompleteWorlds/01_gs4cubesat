...
public class MsgUpdateTcParameter extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public MsgUpdateTcParameter() {}

  /**
   * All-args constructor.
   * @param authorizationToken Authorization token
   * @param tcParameter New data of Tc Parameter object
   */
  public MsgUpdateTcParameter(java.lang.String authorizationToken, com.incomplete.cubegs.common.avro.messages.TC_Parameter tcParameter) {
   ...
   * @return New data of Tc Parameter object
   */
  ...
  /**
   * Creates a new MsgUpdateTcParameter RecordBuilder.
   * @return A new MsgUpdateTcParameter RecordBuilder
   */
  public static com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter.Builder newBuilder() {
    return new com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter.Builder();
  }

  /**
   * Creates a new MsgUpdateTcParameter RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new MsgUpdateTcParameter RecordBuilder
   */
  public static com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter.Builder newBuilder(com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter.Builder other) {
    return new com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter.Builder(other);
  }

  /**
   * Creates a new MsgUpdateTcParameter RecordBuilder by copying an existing MsgUpdateTcParameter instance.
   * @param other The existing instance to copy.
   * @return A new MsgUpdateTcParameter RecordBuilder
   */
  public static com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter.Builder newBuilder(com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter other) {
    return new com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter.Builder(other);
  }

  /**
   * RecordBuilder for MsgUpdateTcParameter instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MsgUpdateTcParameter>
    implements org.apache.avro.data.RecordBuilder<MsgUpdateTcParameter> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing MsgUpdateTcParameter instance
     * @param other The existing instance to copy.
     */
    private Builder(com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.authorizationToken)) {
        this.authorizationToken = data().deepCopy(fields()[0].schema(), other.authorizationToken);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter.Builder setAuthorizationToken(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter.Builder clearAuthorizationToken() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter.Builder setTcParameter(com.incomplete.cubegs.common.avro.messages.TC_Parameter value) {
     ...
     * @return This builder.
     */
    public com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter.Builder setTcParameterBuilder(com.incomplete.cubegs.common.avro.messages.TC_Parameter.Builder value) {
      clearTcParameter();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.incomplete.cubegs.common.avro.messages.MsgUpdateTcParameter.Builder clearTcParameter() {
      tcParameter = null;
    ...
    @Override
    public MsgUpdateTcParameter build() {
      try {
        MsgUpdateTcParameter record = new MsgUpdateTcParameter();
