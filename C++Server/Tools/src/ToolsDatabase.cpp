...
int64_t ToolsDatabase::createTmParameter(const IW::TM_Parameter& inNewParameter)
{
    ...
    query.bind(10, static_cast<int>(inNewParameter.valueType));
    query.bind(11, static_cast<int>(inNewParameter.valueSubType));
    query.bind(12, static_cast<int>(inNewParameter.radix));
