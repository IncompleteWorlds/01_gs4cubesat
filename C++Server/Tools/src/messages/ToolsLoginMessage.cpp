...
ServerMessage ToolsLoginMessage::processMessage(const ServerMessage &inMessage)
{
...
//        ToolsDatabase::getInstance().createUser("user01", avroInputMessage.hashPassword, "user01", "user01", "email@email.com", "mission1",  2);
//        ToolsDatabase::getInstance().createUser("admin", avroInputMessage.hashPassword, "admin", "admin", "email@email.com", "mission1", 3);
//        ToolsDatabase::getInstance().createUser("ro", avroInputMessage.hashPassword, "read-only", "read-only", "email@email.com", "mission1", 1);
