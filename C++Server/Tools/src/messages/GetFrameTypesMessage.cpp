...
//ServerMessage GetFrameTypesMessage::processMessage(const ServerMessage& inMessage, ServerWorkerZmq& inParent)
ServerMessage GetFrameTypesMessage::processMessage(const ServerMessage& inMessage)
{
