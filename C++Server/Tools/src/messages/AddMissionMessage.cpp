...
//ServerMessage AddMissionMessage::processMessage(const ServerMessage &inMessage, ServerWorkerZmq &inParent)
ServerMessage AddMissionMessage::processMessage(const ServerMessage &inMessage)
{
