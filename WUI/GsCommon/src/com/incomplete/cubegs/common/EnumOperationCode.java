...
public enum EnumOperationCode {
    ...
    CODE_GET_STATUS(16),            // It returns the status of a component or a module  
    CODE_GET_STATUS_RESPONSE(17),   // Response for GetStatus message  
    CODE_START_EXECUTION(18),       // It starts the execution of an operation or module
    CODE_STOP_EXECUTION(19),        // It stops or cancels the execution of an operation or module
    ...
    CODE_NEW_PROCESSED_FRAME(302), // Message from HK TM Processor to all subscriber; New Processed Frame
    ...
    CODE_FDS_MESSAGE(403),
    
    msg_propagate_sgp4(404),
    msg_propagate_sgp4_response(404),
