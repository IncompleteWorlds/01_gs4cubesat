...
PROJECT_DIRECTORY="/home/alberto/Projects/01_gs4cubesat/WUI/GsCommon"
...
for ff in *.avro; do
    ...
    java -jar ../../libs/avro-tools-1.11.0.jar  compile   -string schema $proc_filename    $TARGET_MESSAGES_DIRECTORY
