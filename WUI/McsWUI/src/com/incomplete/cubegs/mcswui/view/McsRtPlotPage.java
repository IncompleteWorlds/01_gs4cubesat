...
public class McsRtPlotPage extends McsBasePage  {
	 ...
	 * @param style
	 */
	public McsRtPlotPage(String newViewName, Composite parent, int style) {
    ...
    protected Composite createPlot(Composite parentComposite) {
        ...
        lblNewLabel.setImage(SWTResourceManager.getImage(McsRtPlotPage.class, "/com/incomplete/cubegs/resources/hk_tm_plot.png"));
        ...
        btnAdd.setImage(SWTResourceManager.getImage(McsRtPlotPage.class, "/com/incomplete/cubegs/resources/add_32_32.png"));
        
        Button btnRemove = new Button(composite, SWT.NONE);
        btnRemove.setToolTipText("Remove");
        btnRemove.setImage(SWTResourceManager.getImage(McsRtPlotPage.class, "/com/incomplete/cubegs/resources/minus_32_32.png"));
