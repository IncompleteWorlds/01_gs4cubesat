...
public class McsRtHkTmPage extends McsBasePage  {
	 ...
	 * @param style
	 */
	public McsRtHkTmPage(String newViewName, Composite parent, int style) {
		...
		compTabs.setLayout(new GridLayout(4, false));
		...
		GridData gd_btnPower = new GridData(SWT.CENTER, SWT.TOP, false, false, 1, 1);
